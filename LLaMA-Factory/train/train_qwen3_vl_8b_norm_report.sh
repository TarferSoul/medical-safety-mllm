...
FORCE_TORCHRUN=1 llamafactory-cli train examples/train_full/qwen3_vl_8b_full_sft_norm_report.yaml

# FORCE_TORCHRUN=1 llamafactory-cli train examples/train_full/qwen3_vl_8b_full_sft_norm_report_w_qwen3vl32b_reason.yaml