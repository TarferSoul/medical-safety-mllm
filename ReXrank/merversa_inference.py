...
# /mnt/shared-storage-gpfs2/gpfs2-shared-public/huggingface/zskj-hub/models--hyzhou--MedVersa
import argparse
parser = argparse.ArgumentParser(description='get_entities')
parser.add_argument('--input_json_file', type=str,default='data/iu_xray/ReXRank_IUXray_valid.json')
parser.add_argument('--save_json_file', type=str,default='results/iu_xray/MedVersa.json')
parser.add_argument('--img_root_dir', type=str,default='/mnt/shared-storage-user/ai4good1-share/xieyuejin/datasets/iu_xray/images')
# 解析参数
...
model = model_cls.from_pretrained('/mnt/shared-storage-gpfs2/gpfs2-shared-public/huggingface/zskj-hub/models--hyzhou--MedVersa').to(device).eval()
